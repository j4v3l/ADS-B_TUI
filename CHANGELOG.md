...
### Fixed
- Resolve default config and app data files through XDG user directories for Linux package compatibility, while still honoring existing local `adsb-tui.toml` files.
